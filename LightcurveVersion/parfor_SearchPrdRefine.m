...
%
%   Descriptions:
%       Apply the parallel pool to Refine Period around: P=5.2710h
%   Edited by LUXP
%   Date: 2016-10-07
function parfor_SearchPrdRefine
...
switch i
    case 1
        PrdInterval = 5.1:DeltaPrd:5.2;
        [cg_History, Chisq_History] = SearchPrd(UpdateIndex, PrdInterval,1);
    case 2
        PrdInterval = 5.2:DeltaPrd:5.3;
        [cg_History, Chisq_History] = SearchPrd(UpdateIndex, PrdInterval,1);
    case 3
        PrdInterval = 5.3:DeltaPrd:5.4;
        [cg_History, Chisq_History] = SearchPrd(UpdateIndex, PrdInterval,1);
    case 4
        PrdInterval = -5.3:DeltaPrd:-5.2;
        [cg_History, Chisq_History] = SearchPrd(UpdateIndex, PrdInterval,1);
end
